#ifndef _MODULE_YOLO_FACE_HPP_
#define _MODULE_YOLO_FACE_HPP_
...
class YOLO_FACE_DETECTION_NAIVE;//不带跟踪
class YOLO_FACE_DETECTION_BYTETRACK;//跟踪框架
...
*******************************************************************************/
class YOLO_FACE_DETECTION_NAIVE: public ucloud::AlgoAPI{
public:
/**
 * public API
 */
    YOLO_FACE_DETECTION_NAIVE();
    virtual ~YOLO_FACE_DETECTION_NAIVE();
    ...
    virtual ucloud::RET_CODE set_decode(int mode=4);
...
protected:
    /*******************************************************************************
     * postprocess decode for mode 0,4
    *******************************************************************************/
    virtual ucloud::RET_CODE postprocess(std::vector<float*> &output_datas, float threshold ,float nms_threshold,ucloud::VecObjBBox &bboxes, std::vector<float> &aX, std::vector<float> &aY, int decode_mode);
    virtual ucloud::RET_CODE postprocess(std::vector<float*> &output_datas, ucloud::TvaiRect roi, float threshold ,float nms_threshold,ucloud::VecObjBBox &bboxes, std::vector<float> &aX, std::vector<float> &aY, int decode_mode);
    
    virtual ucloud::RET_CODE rknn_output_to_boxes_mode4( std::vector<float*> &output_datas, float threshold, std::vector<ucloud::VecObjBBox> &bboxes);
...
/*******************************************************************************
 * YOLO_FACE_DETECTION_BYTETRACK
*******************************************************************************/
class YOLO_FACE_DETECTION_BYTETRACK:public AnyDetectionV4ByteTrack{
public:
    YOLO_FACE_DETECTION_BYTETRACK(){
        m_detector = std::make_shared<YOLO_FACE_DETECTION_NAIVE>();
    }
    // virtual ucloud::RET_CODE set_anchor(std::vector<float> &anchors);
    virtual ~YOLO_FACE_DETECTION_BYTETRACK(){}
};
